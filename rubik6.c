...
int printcube(int A[100][100],int B[100][100],int C[100][100],int D[100][100],int E[100][100],int F[100][100]){
	...
	for (i=0;i<=n-1;i++){
		...
		for (j=0;j<=n-1;j++){
			if (A[i][j]==1) {
			printf(ANSI_RESET "%2d",A[i][j]);
			} else if (A[i][j]==2) {
			printf(ANSI_RED "%2d",A[i][j]);	
			} else if (A[i][j]==3) {
			printf(ANSI_GREEN "%2d",A[i][j]);	
			} else if (A[i][j]==4) {
			printf(ANSI_YELLOW "%2d",A[i][j]);	
			} else if (A[i][j]==5) {
			printf(ANSI_CYAN "%2d",A[i][j]);	
			} else if (A[i][j]==6) {
			printf(ANSI_MAGENTA "%2d",A[i][j]);	
			}
		}
		printf("\n");
	}
	...
	for (i=0;i<=n-1;i++){
		...
		for (j=0;j<=n-1;j++){
			if (E[i][j]==1) {
				printf(ANSI_RESET "%2d",E[i][j]);
			} else if (E[i][j]==2) {
				printf(ANSI_RED "%2d",E[i][j]);	
			} else if (E[i][j]==3) {
				printf(ANSI_GREEN "%2d",E[i][j]);	
			} else if (E[i][j]==4) {
				printf(ANSI_YELLOW "%2d",E[i][j]);	
			} else if (E[i][j]==5) {
				printf(ANSI_CYAN "%2d",E[i][j]);	
			} else if (E[i][j]==6) {
				printf(ANSI_MAGENTA "%2d",E[i][j]);	
			}			
		}
		...
		for (j=0;j<=n-1;j++){
			if (B[i][j]==1) {
				printf(ANSI_RESET "%2d",B[i][j]);
			} else if (B[i][j]==2) {
				printf(ANSI_RED "%2d",B[i][j]);	
			} else if (B[i][j]==3) {
				printf(ANSI_GREEN "%2d",B[i][j]);	
			} else if (B[i][j]==4) {
				printf(ANSI_YELLOW "%2d",B[i][j]);	
			} else if (B[i][j]==5) {
				printf(ANSI_CYAN "%2d",B[i][j]);	
			} else if (B[i][j]==6) {
				printf(ANSI_MAGENTA "%2d",B[i][j]);	
			}	
		}
		...
		for (j=0;j<=n-1;j++){
			if (C[i][j]==1) {
				printf(ANSI_RESET "%2d",C[i][j]);
			} else if (C[i][j]==2) {
				printf(ANSI_RED "%2d",C[i][j]);	
			} else if (C[i][j]==3) {
				printf(ANSI_GREEN "%2d",C[i][j]);	
			} else if (C[i][j]==4) {
				printf(ANSI_YELLOW "%2d",C[i][j]);	
			} else if (C[i][j]==5) {
				printf(ANSI_CYAN "%2d",C[i][j]);	
			} else if (C[i][j]==6) {
				printf(ANSI_MAGENTA "%2d",C[i][j]);	
			}	
		}
		printf("\n");
	}
	...
	for (i=0;i<=n-1;i++){
		...
		for (j=0;j<=n-1;j++){
			if (F[i][j]==1) {
			printf(ANSI_RESET "%2d",F[i][j]);
			} else if (F[i][j]==2) {
			printf(ANSI_RED "%2d",F[i][j]);	
			} else if (F[i][j]==3) {
			printf(ANSI_GREEN "%2d",F[i][j]);	
			} else if (F[i][j]==4) {
			printf(ANSI_YELLOW "%2d",F[i][j]);	
			} else if (F[i][j]==5) {
			printf(ANSI_CYAN "%2d",F[i][j]);	
			} else if (F[i][j]==6) {
			printf(ANSI_MAGENTA "%2d",F[i][j]);	
			}
		}
		printf("\n");
	}
	...
	for (i=0;i<=n-1;i++){
		...
		for (j=0;j<=n-1;j++){
			if (D[i][j]==1) {
			printf(ANSI_RESET "%2d",D[i][j]);
			} else if (D[i][j]==2) {
			printf(ANSI_RED "%2d",D[i][j]);	
			} else if (D[i][j]==3) {
			printf(ANSI_GREEN "%2d",D[i][j]);	
			} else if (D[i][j]==4) {
			printf(ANSI_YELLOW "%2d",D[i][j]);	
			} else if (D[i][j]==5) {
			printf(ANSI_CYAN "%2d",D[i][j]);	
			} else if (D[i][j]==6) {
...
int shuff(int A[100][100],int B[100][100],int C[100][100],int D[100][100],int E[100][100],int F[100][100]){
	...
	for (i=0;i<=30;i++) solv(A,B,C,D,E,F);
}


int solv(int A[100][100],int B[100][100],int C[100][100],int D[100][100],int E[100][100],int F[100][100]){
	int i,nb;
